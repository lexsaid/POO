...
public class CuentaBancariaV1Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Cliente 2 despues del deposito de 8500");
        System.out.println("Cliente 2 : " + cliente2);
        if( cliente2.getCuenta().retira(1500) )
            System.out.println("El retiro de 1500 efectuado con exito, nuevo saldo " +cliente2.getCuenta().getSaldo());
        else 
